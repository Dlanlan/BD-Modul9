...
<body style="background-color: #f3f3f3;">
    ...
    <div class="container mt-3" style="background-color: #b3b3b3; border-radius: 5px;">
        ...
        <table class="table table-striped table-hover mt-3">
            ...
            <form action="act_update2.php" method="POST">
                <tr>
                    <td><label>ID Pegawai : </label></td>
                    <td><input type="text" name="ID_pegawai" readonly placeholder="ID_pegawai" autofocus value="<?php echo $sql['ID_pegawai']; ?>" /></td>
                </tr>

                <tr>
                    <td><label>Nama Pegawai : </label></td>
                    <td><input type="text" name="Nama_pegawai" placeholder="Nama_pegawai" autofocus value="<?php echo $sql['Nama_pegawai']; ?>" /></td>
                </tr>

                <tr>
                    <td><label>Alamat : </label></td>
                    <td><input type="text" name="Alamat" placeholder="Alamat" autofocus value="<?php echo $sql['Alamat']; ?>" /></td>
                </tr>

                <tr>
                    <td><label>No Telp : </label></td>
                    <td><input type="text" name="Nomor_telepon" placeholder="Nomor_telepon" autofocus value="<?php echo $sql['Nomor_telepon']; ?>" /></td>
                </tr>
