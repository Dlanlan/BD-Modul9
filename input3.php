...
<body style="background-color: #f3f3f3;">
    ...
    <div class="container mt-3" style="background-color: #b3b3b3; border-radius: 5px;">
        ...
        <table class="table table-striped table-hover mt-3">
            ...
            <form action="act_input3.php" method="POST">
                <tr>
                    <td><label>ID Bentuk : </label></td>
                    <td><input type="text" name="ID_bentuk" placeholder="ID_bentuk"></td>
                </tr>

                <tr>
                    <td><label>Nama Bentuk : </label></td>
                    <td><input type="text" name="Nama_bentuk" placeholder="Nama_bentuk"></td>
                </tr>
