...
<body style="background-color: #f3f3f3;">
    ...
    <div class="container mt-3" style="background-color: #b3b3b3; border-radius: 5px;">
        ...
        <table class="table table-striped table-hover mt-3">
            ...
            <form action="act_input.php" method="POST">
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="Nama_barang" placeholder="Nama_barang"></td>
                </tr>

                <tr>
                    <td><label>Jenis Barang : </label></td>
                    <td><input type="text" name="Jenis_barang" placeholder="Jenis_barang"></td>
                </tr>

                <tr>
                    <td><label>Bentuk Barang : </label></td>
                    <!-- <td><input type="text" name="Bentuk_barang" placeholder="Bentuk_barang"></td> -->
                    <td>
                        <?php
                ...
                <tr>
                    ...
                    <td><input type="date" name="Kadaluarsa" placeholder="Kadaluarsa"></td>
                </tr>
